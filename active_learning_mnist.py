...
if __name__ == '__main__':
    ...
    acc_baseline = eval_prioritization_strategy(data, model, trivial_strategy)
    acc_entropy = eval_prioritization_strategy(data, model, max_entropy_strategy)
    acc_bt = eval_prioritization_strategy(data, model, least_margin_strategy)
    acc_vr = eval_prioritization_strategy(data, model, least_confidence_strategy)
